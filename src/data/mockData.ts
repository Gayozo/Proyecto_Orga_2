...
// Mapa de Custodia Comercial y Facturación de Origen por Lote
export const LOTE_CUSTODIA_MAP: Record<string, CustodiaLoteInfo> = {
  'LOT-YOG-2026-001-RET': {
    lote_id: 'LOT-YOG-2026-001-RET',
    mayorista_codigo: 'DM Z5 1',
    mayorista_nombre: 'Distribuciones Guaraní S.R.L. (DM Z5 1)',
    mayorista_ruc: '80092144-1',
    cedi_origen: 'CEDI Z5 - Ciudad del Este',
    factura_venta_nro: '001-003-0045812',
    fecha_despacho: '2026-07-05',
    furgon_transporte: 'Scania R450 / Furgón Thermo King - Chapa HAX-891',
    temperatura_salida: 3.2,
    unidades_despachadas: 240,
    saldo_disponible_devolucion: 180,
    precio_unitario_gs: 9500
  },
  'LOT-LECH-2026-009': {
    lote_id: 'LOT-LECH-2026-009',
    mayorista_codigo: 'DM Z5 2',
    mayorista_nombre: 'Logística & Lácteos del Este (DM Z5 2)',
    mayorista_ruc: '80045781-3',
    cedi_origen: 'CEDI Z5 - Ciudad del Este',
    factura_venta_nro: '001-003-0045920',
    fecha_despacho: '2026-07-20',
    furgon_transporte: 'Mercedes Actros #14 - Chapa BKL-890',
    temperatura_salida: 3.4,
    unidades_despachadas: 400,
    saldo_disponible_devolucion: 240,
    precio_unitario_gs: 6800
  },
  'LOT-QUES-2026-081': {
    lote_id: 'LOT-QUES-2026-081',
    mayorista_codigo: 'DM Z5 4',
    mayorista_nombre: 'Distribuidora San Miguel S.A. (DM Z5 4)',
    mayorista_ruc: '80031980-9',
    cedi_origen: 'CEDI Z5 - Ciudad del Este',
    factura_venta_nro: '001-003-0046102',
    fecha_despacho: '2026-08-05',
    furgon_transporte: 'Volvo FMX - Chapa CAL-445',
    temperatura_salida: 3.0,
    unidades_despachadas: 150,
    saldo_disponible_devolucion: 65,
    precio_unitario_gs: 28500
  },
  'LOT-YOG-2026-004': {
    lote_id: 'LOT-YOG-2026-004',
    mayorista_codigo: 'DM Z1 3',
    mayorista_nombre: 'Trans-Ruta Comercial S.A. (DM Z1 3)',
    mayorista_ruc: '80062411-5',
    cedi_origen: 'CEDI Z1 - Asunción',
    factura_venta_nro: '001-002-0089124',
    fecha_despacho: '2026-08-22',
    furgon_transporte: 'Scania R410 - Chapa ABZ-120',
    temperatura_salida: 3.3,
    unidades_despachadas: 180,
    saldo_disponible_devolucion: 48,
    precio_unitario_gs: 9500
  },
  'LOT-DULC-2026-007': {
    lote_id: 'LOT-DULC-2026-007',
    mayorista_codigo: 'DM Z1 4',
    mayorista_nombre: 'Distribuidora San Miguel S.A. (DM Z1 4)',
    mayorista_ruc: '80031980-9',
    cedi_origen: 'CEDI Z1 - Asunción',
    factura_venta_nro: '001-002-0089201',
    fecha_despacho: '2026-08-20',
    furgon_transporte: 'Mercedes Atego - Chapa KLO-990',
    temperatura_salida: 3.8,
    unidades_despachadas: 300,
    saldo_disponible_devolucion: 120,
    precio_unitario_gs: 16000
  },
  'LOT-LECH-2026-002': {
    lote_id: 'LOT-LECH-2026-002',
    mayorista_codigo: 'DM Z1 5',
    mayorista_nombre: 'Logística Capilar del Sur S.R.L. (DM Z1 5)',
    mayorista_ruc: '80077892-8',
    cedi_origen: 'CEDI Z1 - Asunción',
    factura_venta_nro: '001-002-0089330',
    fecha_despacho: '2026-08-21',
    furgon_transporte: 'Volvo FM - Chapa YAZ-771',
    temperatura_salida: 3.1,
    unidades_despachadas: 200,
    saldo_disponible_devolucion: 60,
    precio_unitario_gs: 6800
  },
  'LOT-LECH-2026-012': {
    lote_id: 'LOT-LECH-2026-012',
    mayorista_codigo: 'DM Z1 1',
    mayorista_nombre: 'Distribuciones Guaraní S.R.L. (DM Z1 1)',
    mayorista_ruc: '80092144-1',
    cedi_origen: 'CEDI Z1 - Asunción',
    factura_venta_nro: '001-002-0089450',
    fecha_despacho: '2026-08-22',
    furgon_transporte: 'Scania R450 - Chapa BKL-890',
    temperatura_salida: 3.2,
    unidades_despachadas: 2500,
    saldo_disponible_devolucion: 2500,
    precio_unitario_gs: 6800
  },
  'LOT-QUES-2026-088': {
    lote_id: 'LOT-QUES-2026-088',
    mayorista_codigo: 'DM Z4 3',
    mayorista_nombre: 'Trans-Ruta Comercial S.A. (DM Z4 3)',
    mayorista_ruc: '80062411-5',
    cedi_origen: 'CEDI Z4 - Abasto Norte',
    factura_venta_nro: '001-004-0012099',
    fecha_despacho: '2026-08-10',
    furgon_transporte: 'Volvo FMX #07',
    temperatura_salida: 3.0,
    unidades_despachadas: 200,
    saldo_disponible_devolucion: 150,
    precio_unitario_gs: 28500
  },
  'LOT-CHOC-2026-031': {
    lote_id: 'LOT-CHOC-2026-031',
    mayorista_codigo: 'DM Z12 2',
    mayorista_nombre: 'Logística & Lácteos del Este (DM Z12 2)',
    mayorista_ruc: '80045781-3',
    cedi_origen: 'CEDI Z12 - Encarnación',
    factura_venta_nro: '001-012-0003410',
    fecha_despacho: '2026-08-02',
    furgon_transporte: 'Scania R450 #12',
    temperatura_salida: 3.1,
    unidades_despachadas: 500,
    saldo_disponible_devolucion: 300,
    precio_unitario_gs: 4500
  }
};

// Notas de Crédito Electrónicas iniciales emitidas ante la DNIT (KuDE / SIFEN Paraguay)
export const INITIAL_NOTAS_CREDITO: FacNotaCredito[] = [
  {
    id_nota_credito: 'NC-2026-0001842',
    nro_comprobante_nc: '001-005-0001842',
    timbrado_nro: '16428910',
    cdc: '01800012345001005000184222026090615481234567',
    fecha_emision: '2026-09-06 14:15',
    fk_devolucion: 101,
    fk_lote: 'LOT-YOG-2026-001-RET',
    nombre_producto: 'Yogur Bebible Frutilla 1L',
    fk_distribuidor_codigo: 'DM Z5 1',
    nombre_distribuidor: 'Distribuciones Guaraní S.R.L.',
    ruc_distribuidor: '80092144-1',
    factura_venta_afectada: '001-003-0045812',
    furgon_frio: 'Scania R450 / Furgón Thermo King - Chapa HAX-891',
    cantidad_unidades: 180,
    unidad: 'Litros',
    precio_unitario_gs: 9500,
    exenta_gs: 0,
    gravada_5_gs: 1710000,
    iva_5_gs: Math.round(1710000 / 21), // Liquidación IVA 5% según Ley 6380/19
    total_nc_gs: 1710000,
    motivo_nc: 'Devolución por fecha vencida en góndola (F13)',
    estado_dnit: 'Aprobado SIFEN'
  },
  {
    id_nota_credito: 'NC-2026-0001841',
    nro_comprobante_nc: '001-005-0001841',
    timbrado_nro: '16428910',
    cdc: '01800012345001005000184122026090511201984210',
    fecha_emision: '2026-09-05 11:30',
    fk_devolucion: 102,
    fk_lote: 'LOT-LECH-2026-009',
    nombre_producto: 'Leche Entera UHT Clásica 1L',
    fk_distribuidor_codigo: 'DM Z5 2',
    nombre_distribuidor: 'Logística & Lácteos del Este',
    ruc_distribuidor: '80045781-3',
    factura_venta_afectada: '001-003-0045920',
    furgon_frio: 'Mercedes Actros #14 - Chapa BKL-890',
    cantidad_unidades: 240,
    unidad: 'Litros',
    precio_unitario_gs: 6800,
    exenta_gs: 0,
    gravada_5_gs: 1632000,
    iva_5_gs: Math.round(1632000 / 21),
    total_nc_gs: 1632000,
    motivo_nc: 'Devolución por defecto de acidez térmica (F10)',
    estado_dnit: 'Aprobado SIFEN'
  },
  {
    id_nota_credito: 'NC-2026-0001840',
    nro_comprobante_nc: '001-005-0001840',
    timbrado_nro: '16428910',
    cdc: '01800012345001005000184022026090414309981245',
    fecha_emision: '2026-09-04 14:35',
    fk_devolucion: 103,
    fk_lote: 'LOT-QUES-2026-081',
    nombre_producto: 'Queso Paraguay Tradicional 500g',
    fk_distribuidor_codigo: 'DM Z5 4',
    nombre_distribuidor: 'Distribuidora San Miguel S.A.',
    ruc_distribuidor: '80031980-9',
    factura_venta_afectada: '001-003-0046102',
    furgon_frio: 'Volvo FMX - Chapa CAL-445',
    cantidad_unidades: 65,
    unidad: 'Unidades (500g)',
    precio_unitario_gs: 28500,
    exenta_gs: 0,
    gravada_5_gs: 1852500,
    iva_5_gs: Math.round(1852500 / 21),
    total_nc_gs: 1852500,
    motivo_nc: 'Devolución por caducidad en punto de venta (F13)',
    estado_dnit: 'Aprobado SIFEN'
  }
];
